...
function CTASection() {
  ...
  const { ref: ctaRef, visible: ctaVisible } = useScrollAnimation();
      ...
      <section style={{
        ...
        <div ref={ctaRef} style={{ position: "relative", zIndex: 2 }}>
          ...
          <div style={{
            ...
            marginBottom: 20,
            opacity: 0.8,
            ...animStyle(ctaVisible, { direction: "up", delay: 0 }),
          }}>
          ...
          <h2 style={{
            ...
            ...animStyle(ctaVisible, { direction: "up", delay: 0.1 }),
          }}>
            Votre Héritage<br />
          ...
          <p style={{
            ...
            ...animStyle(ctaVisible, { direction: "up", delay: 0.2 }),
          }}>
          ...
          {count !== null && (
            <div style={{
              ...
              padding: "10px 24px",
              marginBottom: 32,
              ...animStyle(ctaVisible, { direction: "up", delay: 0.3 }),
            }}>
              <div style={{
                width: 8, height: 8, borderRadius: "50%",
                background: "#3d8a38", boxShadow: "0 0 8px #3d8a38",
              ...
              <span style={{
                ...
                <strong style={{ color: "#3d8a38", fontSize: isMobile ? 14 : 16, filter: "brightness(1.3)" }}>
                  {count}
                </strong>
          ...
          <div style={{
            ...
            alignItems: "center",
            ...animStyle(ctaVisible, { direction: "up", delay: 0.4 }),
          }}>
            <button
              style={{
                fontFamily: "'Cinzel', serif",
              ...
              onMouseEnter={(e) => { e.currentTarget.style.transform = "scale(1.06)"; e.currentTarget.style.boxShadow = "0 16px 50px rgba(37,79,34,0.5)"; }}
              onMouseLeave={(e) => { e.currentTarget.style.transform = "scale(1)"; e.currentTarget.style.boxShadow = "0 10px 40px rgba(37,79,34,0.3)"; }}
            >
              ▶ Jouer Gratuitement
            </button>
            <button
        ...
        <div onClick={handleClose} style={{
          ...
          <div onClick={(e) => e.stopPropagation()} style={{
            ...
            <button onClick={handleClose} style={{
              ...
              color: "rgba(37,79,34,0.8)", fontSize: 24,
              cursor: "pointer", fontWeight: 700,
              filter: "brightness(1.8)", lineHeight: 1,
            }}>×</button>
            ...
            {!submitted ? (
              <>
                <div style={{ textAlign: "center", marginBottom: 32 }}>
                  <div style={{
                    ...
                    color: "var(--or)", fontSize: 12, letterSpacing: "0.3em",
                    textTransform: "uppercase", marginBottom: 10, opacity: 0.8,
                  }}>Accès Anticipé</div>
                  <h2 style={{
                    fontFamily: "'Cinzel', serif", color: "var(--creme)",
                    fontSize: isMobile ? 20 : 26, fontWeight: 900,
                    letterSpacing: "0.08em", marginBottom: 8,
                  }}>Réserver Ma Place</h2>
                  <div style={{
                    width: 40, height: 2, background: "#254F22",
                    margin: "0 auto 12px auto", borderRadius: 2, filter: "brightness(1.5)",
                  }} />
                  {count !== null && (
                    <p style={{
                      fontFamily: "'Cormorant Garamond', serif",
                      color: "rgba(245,236,215,0.4)", fontSize: 13,
                      fontStyle: "italic", marginBottom: 8,
                    }}>
                      Rejoignez les{" "}
                      <strong style={{ color: "#3d8a38", filter: "brightness(1.3)" }}>{count}</strong>
                      {" "}joueurs déjà inscrits
                    </p>
                  )}
                  <p style={{
                    fontFamily: "'Cormorant Garamond', serif",
                    color: "rgba(245,236,215,0.5)", fontSize: 15, fontStyle: "italic",
                  }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                  <div>
                    ...
                    <input type="text" placeholder="Votre nom" value={formData.nom}
                  ...
                  <div>
                    ...
                    <select value={formData.plateforme}
                  ...
                  <button onClick={handleSubmit}
                    ...
                    style={{
                      ...
                      letterSpacing: "0.15em", fontWeight: 700, color: "#fff",
                      background: (!formData.nom || !formData.email || !formData.plateforme)
                        ? "rgba(37,79,34,0.3)" : "linear-gradient(135deg, #254F22 0%, #3d8a38 100%)",
                      border: "none", padding: "16px 32px", borderRadius: 4,
                      cursor: (!formData.nom || !formData.email || !formData.plateforme) ? "not-allowed" : "pointer",
                      textTransform: "uppercase", transition: "all 0.3s",
                      boxShadow: "0 8px 30px rgba(37,79,34,0.3)", marginTop: 8,
                    }}>
                    {loading ? "Réservation en cours..." : "✦ Réserver Ma Place"}
                  </button>
                  <p style={{
                    fontFamily: "'Cormorant Garamond', serif", fontStyle: "italic",
                    color: "rgba(245,236,215,0.25)", fontSize: 12, textAlign: "center",
                  }}>
              ...
              <div style={{ textAlign: "center", padding: "20px 0" }}>
                ...
                <h2 style={{
                  fontFamily: "'Cinzel', serif", color: "var(--or)",
                  fontSize: isMobile ? 20 : 24, marginBottom: 8, letterSpacing: "0.08em",
                }}>Place Réservée !</h2>
                <div style={{
                  width: 40, height: 2, background: "#254F22",
                  margin: "0 auto 20px auto", borderRadius: 2, filter: "brightness(1.5)",
                }} />
                <p style={{
                  fontFamily: "'Cormorant Garamond', serif",
                  color: "rgba(245,236,215,0.7)", fontSize: 17,
                ...
                <p style={{
                  fontFamily: "'Cormorant Garamond', serif", fontStyle: "italic",
                  color: "rgba(245,236,215,0.3)", fontSize: 13, marginTop: 24,
                }}>
                ...
                <button onClick={handleClose} style={{
                  ...
                  border: "none", padding: "12px 32px", borderRadius: 4,
                  cursor: "pointer", textTransform: "uppercase", marginTop: 24,
