...
function CTASection() {
  ...
  const GOOGLE_SCRIPT_URL =
    "https://script.google.com/macros/s/AKfycbwS_-7EZYGz7WJoKnR_pSpMshZIbF3bMo1BEx7bD4InBzj4QquS0nsLhOfKpfc1ChS4/exec";
    ...
    <>
      <section
        style={{
          position: "relative",
          background:
            "linear-gradient(180deg, #150A06 0%, #0D0805 50%, #0a2612 100%)",
      ...
      >
        ...
        <div
          style={{
            ...
            background:
              "radial-gradient(circle, rgba(37,79,34,0.08) 0%, transparent 70%)",
            borderRadius: "50%",
            pointerEvents: "none",
          }}
        />
            ...
            <button
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow =
                  "0 16px 50px rgba(37,79,34,0.5)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = "scale(1)";
                e.currentTarget.style.boxShadow =
                  "0 10px 40px rgba(37,79,34,0.3)";
              }}
            >
              ▶ Jouer Gratuitement
            </button>
        ...
        >
          <div
            ...
            style={{
              ...
              position: "relative",
              boxShadow:
                "0 20px 60px rgba(0,0,0,0.8), 0 0 40px rgba(37,79,34,0.15)",
              maxHeight: "90vh",
              overflowY: "auto",
            }}
          >
            ...
            {!submitted ? (
                ...
                <div style={{ textAlign: "center", marginBottom: 32 }}>
                  ...
                  {count !== null && (
                    ...
                    >
                      Rejoignez les{" "}
                      <strong
                        style={{ color: "#3d8a38", filter: "brightness(1.3)" }}
                      >
                        {count}
                      </strong>{" "}
                ...
                >
                  <div>
                    ...
                    <input
                      ...
                      onBlur={(e) =>
                        (e.target.style.borderColor = "rgba(37,79,34,0.4)")
                      }
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    >
                      <option value="" style={{ background: "#0d1a0c" }}>
                        Choisir une plateforme
                      </option>
                      <option value="pc" style={{ background: "#0d1a0c" }}>
                        PC / Windows
                      </option>
                      <option value="mac" style={{ background: "#0d1a0c" }}>
                        Mac
                      </option>
                      <option value="mobile" style={{ background: "#0d1a0c" }}>
                        Mobile (Android / iOS)
                      </option>
                      <option value="console" style={{ background: "#0d1a0c" }}>
                        Console
                      </option>
                    </select>
                  </div>
                  <button
                    ...
                    style={{
                      ...
                      color: "#fff",
                      background:
                        !formData.nom || !formData.email || !formData.plateforme
                          ? "rgba(37,79,34,0.3)"
              ...
              <div style={{ textAlign: "center", padding: "20px 0" }}>
                ...
                >
                  Merci{" "}
                  <strong style={{ color: "var(--or)" }}>{formData.nom}</strong>{" "}
                  !<br />
        ...
        >
          ...
          >
            ...
            <div style={{ textAlign: "center", padding: "20px 0" }}>
              ...
              >
                Le jeu KARATAKA est actuellement en cours de développement.
                <br />
                <strong style={{ color: "var(--or)" }}>
                  Disponible bientôt !
                </strong>
              ...
              >
                « La récolte viendra en son temps. »
              </p>
              <button
                onClick={handleCloseDownload}
                style={{
